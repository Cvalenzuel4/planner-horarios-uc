...
export function CourseCard({ curso, seccionesSeleccionadasIds, onToggleSeccion }: CourseCardProps) {
    ...
    return (
        <div className={`bg-white rounded-xl border p-4 transition-all duration-200 shadow-sm ${estaSeleccionada ? 'border-orange-400 bg-orange-50' : 'border-gray-200 hover:border-gray-300 hover:shadow'}`}>
